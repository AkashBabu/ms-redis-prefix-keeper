...
var _only = require('only');var _only2 = _interopRequireDefault(_only);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}exports.default = function () {var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(
    ...
    function _callee(_ref, cb) {var request = _ref.request;var _ref3, _ref4, msDetails;return _regenerator2.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_context.prev = 0;_context.next = 3;return (
                        ...
                        _logger2.default.debug('GetMs:', (0, _only2.default)(msDetails, 'id name type dependents dependencies version maintainers'));
                        // delete msDetails._id;
                        cb(null, {
                            success: !!msDetails,
                        ...
                        cb(null, {
                            success: false,
                            message: _context.t0.toString() });case 14:case 'end':return _context.stop();}}}, _callee, this, [[0, 10]]);}));function _GetMS(_x, _x2) {return _ref2.apply(this, arguments);}return _GetMS;}();